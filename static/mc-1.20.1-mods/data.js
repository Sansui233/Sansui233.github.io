const MODS_DATA = [
    // 核心库
    { name: "Fabric API", file: "fabric-api-0.92.2+1.20.1.jar", category: "library", deps: [], desc: "Fabric 模组开发的核心 API 库", mcVersion: "1.20.1" },
    ...
    { name: "FallingTree", file: "fallingtrees-fabric-0.12.7-1.20.jar", category: "gameplay", deps: ["Fabric API", "PandaLib"], desc: "快速砍树", mcVersion: "1.20" },
    ...
    { name: "Controlling", file: "Controlling-fabric-1.20.1-12.0.2.jar", category: "utility", deps: ["Fabric API"], desc: "键位冲突显示", mcVersion: "1.20.1" },
